...
|--------|------------------|------|-------|
| 3a Skill creation | [Intro to Agent Skills](https://anthropic.skilljar.com/introduction-to-agent-skills) · [Skills docs](https://code.claude.com/docs/en/skills) | [02 — /backtest-report](../demos/02-backtest-report-skill.md) (both) · [06 — /regression-diagnostics](../demos/06-regression-diagnostics.md) (quant) | ship one Skill for a recurring task |
